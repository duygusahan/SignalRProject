...
namespace SignalRWebUi.Controllers
{
    public class BookingController : Controller
    {
        ...
        {
            var client = _httpClientFactory.CreateClient();
            await client.GetAsync("https://localhost:7009/api/Booking/BookingStatusApproved?id=" + id);
            return RedirectToAction("Index");
        }
		...
		{
			var client = _httpClientFactory.CreateClient();
			await client.GetAsync("https://localhost:7009/api/Booking/BookingStatusCancelled?id=" + id);
			return RedirectToAction("Index");
		}
